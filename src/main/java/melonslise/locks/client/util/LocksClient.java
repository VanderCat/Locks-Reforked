...
////                }
////            }
////            renderLock(state, mtx, buf, ch, pt, mc, o, mut);
////        }
////        buf.endBatch();
//    }
//
//    public static void renderLock(Lockable.State state, PoseStack mtx, MultiBufferSource.BufferSource buf, Frustum ch, float pt, Minecraft mc, Vec3 o, BlockPos.MutableBlockPos mut) {
////        mtx.pushPose();
